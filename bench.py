...
profile = False # 使用pytorch profiler，还是只是简单的基准测试？
...
# 模型初始化
gptconf = GPTConfig(
    block_size = block_size, # 模型能往回看多远？即上下文大小
...
if profile:
    ...
    with torch.profiler.profile(
        ...
        with_flops=True,
        with_modules=False, # 目前仅用于torchscript模型
    ) as prof:
